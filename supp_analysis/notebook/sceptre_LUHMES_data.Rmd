...
`code/run_sceptre_LUHMES_data.R`

```{bash, include=FALSE, eval=FALSE}
sbatch --mem=50G --cpus-per-task=10 ~/projects/GSFA_analysis/code/run_sceptre_LUHMES_data.sbatch
```

Permutation analysis:
`code/run_sceptre_LUHMES_permuted_data.R`
