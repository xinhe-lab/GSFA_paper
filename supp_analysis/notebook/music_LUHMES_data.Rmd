---
title: "MUSIC analysis on LUHMES CROP-seq data"
author: "Kaixuan Luo"
output:
...
```{r data-preprocesing, eval=FALSE}
...
```{r Get_high_varGenes, eval=FALSE}
...
```{r load_summary_df_20topics, message = FALSE, warning=FALSE}
...
```{r empirical_tstats_heatmap_20topics, eval=TRUE, fig.width=12, fig.height=8}
...
```{r load_summary_df_4topics, warning=FALSE, message=FALSE}
...
```{r empirical_tstats_heatmap_4topics, fig.width=12, fig.height=8}
