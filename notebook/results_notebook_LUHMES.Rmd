...
```{r}
source("/project2/xinhe/yifan/Factor_analysis/paper/R/plotting_functions.R")
data_folder <- "/project2/xinhe/yifan/Factor_analysis/paper/data/LUHMES/"

G_mat <- readRDS(paste0(data_folder, "perturbation_matrix.rds"))
gibbs_PM <- readRDS(paste0(data_folder, "gsfa_posterior_means.rds"))
lfsr_mat <- readRDS(paste0(data_folder, "lfsr_matrix.rds"))
...
named_lfsr_mat <- lfsr_mat
rownames(named_lfsr_mat) <- genes_df$Name[match(rownames(lfsr_mat), genes_df$ID)]
